...
2. 打开 [bella-gif-helper.user.js](bella-gif-helper.user.js)。发布后也可以直接访问其 [原始文件](https://raw.githubusercontent.com/Bellaris-Weekly/bella-gif-helper/main/bella-gif-helper.user.js) 触发安装。
